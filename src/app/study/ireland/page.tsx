...
const StudyProcessIreland: React.FC = () => {
  ...
  const studySteps: StudyStep[] = [
    {
      ...
      description:
        "Explore universities and colleges in Ireland that align with your goals. Factor in tuition, location, and student support.",
    ...
    },
    {
      ...
      description:
        "Use your Offer Letter to apply for an Ireland student visa. Include financial and health documents.",
      icon: <ShieldCheck className="w-full h-full from-inherit" />,
    },
    {
      step: 6,
      ...
      icon: <PlaneTakeoff className="w-full h-full from-inherit" />,
    },
  ];
  ...
  const sidebarLinks: SidebarLink[] = [
    ...
    { href: "/study/newzealand", label: "Study in New Zealand" },
    { href: "/study/usa", label: "Study in USA" },
    { href: "/study/ireland", label: "Study in Ireland", active: true },
  ];

  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Study Process for Ireland | GenZ Global</title>
        <meta
          name="description"
          content="Learn about the step-by-step process to study in Ireland with GenZ Global."
        />
        ...
        <div className="absolute inset-0 bg-black bg-opacity-[0.5] flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold drop-shadow-lg">
              Study in{" "}
              <span className="text-GenZ-secondary shadow-inner">Ireland</span>
            </h1>
            <p className="mt-4 text-lg sm:text-xl max-w-md mx-auto drop-shadow-md">
              Begin your academic journey with GenZ Global in a vibrant and innovative country
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-6">
              ...
              <span className="text-GenZ-secondary">Ireland</span>
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl">
              GenZ Global is here to make your dream of studying in Ireland a reality. Follow these steps to start your future today.
            </p>
...
export default StudyProcessIreland;
