(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9141a7._.js", {
...
function Home() {
    ...
    const { data: jobResult, isLoading: isPolling, isError, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        enabled: !!jobId,
        refetchInterval: {
            "Home.useQuery": (data)=>data?.data?.status === "completed" || data?.data?.status === "error" ? false : 2000
        }["Home.useQuery"]
    });
...
//# sourceMappingURL=_9141a7._.js.map